...
async function main() {
  ...
  for (const game of schedule) {
    ...
    games.push({
      ...
      awayBat_l10: frac(awayBatStats.games - awayBatStats.l10ScoredCount, Math.min(awayBatStats.games, 10)),
      homeSP_l10: frac(homeSpStats.l10NrfiCount, homeSpStats.l10Starts),
      homeSP_szn: frac(homeSpStats.nrfiCount, homeSpStats.starts),
      homeBat_l10: frac(homeBatStats.games - homeBatStats.l10ScoredCount, Math.min(homeBatStats.games, 10)),
      edge,
      edgeLabel,
      ...(note && { note }),
      detail: {
